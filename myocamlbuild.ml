(* OASIS_START *)
(* DO NOT EDIT (digest: e4e0c37adc46febc77496cfe34ec2dc4) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("mlsmoke/mlsmoke",
            ["mlsmoke"; "mlsmoke/Qt"; "mlsmoke/QtStruct"; "mlsmoke/Smoke"])
       ];
     lib_c = [("mlsmoke", "mlsmoke", [])];
     flags =
       [
          (["oasis_library_mlsmoke_cclib"; "link"],
            [
          ...
          (["oasis_library_mlsmoke_cclib"; "ocamlmklib"; "c"],
            [
               (OASISExpr.EBool true,
                 S [A "-lsmokebase"; A "-lsmokeqtcore"; A "-lsmokeqtgui"])
            ])
       ];
     }
  ;;
